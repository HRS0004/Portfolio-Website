...
export default function Footer() {
    return (
        <footer className="py-16 px-6 lg:px-24 border-t-2 border-primary/20 bg-neutral-950" data-testid="footer">
            <div className="max-w-7xl mx-auto">
                {/* CTAs - HUGE & CENTERED */}
                <div className="text-center mb-16">
                    <h3 className="text-3xl lg:text-4xl font-bold mb-3">Let's Work Together</h3>
                    <p className="text-lg text-neutral-400 mb-8">Open to new opportunities in 3D web development</p>
