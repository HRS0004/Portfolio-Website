    ...
    useEffect(() => {
        ...
        const animate = () => {
            ...
            particles.forEach((particle, index) => {
                ...
                // Use website colors: primary blue and secondary cyan
                if (index % 2 === 0) {
                    gradient.addColorStop(0, `rgba(59, 130, 246, ${particle.opacity})`) // primary blue
                    gradient.addColorStop(1, 'rgba(59, 130, 246, 0)')
                } else {
                    gradient.addColorStop(0, `rgba(6, 182, 212, ${particle.opacity})`) // secondary cyan
